...
DeviceDriver_VirtualCheap::DeviceDriver_VirtualCheap()
{
    ...
    char buf[1024];
    vr::VRSettings()->GetString( k_pch_VirtualCheap_Section, k_pch_VirtualCheap_SerialNumber_String, buf, sizeof( buf ) );
    m_sSerialNumber = buf;

    vr::VRSettings()->GetString( k_pch_VirtualCheap_Section, k_pch_VirtualCheap_ModelNumber_String, buf, sizeof( buf ) );
    m_sModelNumber = buf;

    m_nWindowX = vr::VRSettings()->GetInt32( k_pch_VirtualCheap_Section, k_pch_VirtualCheap_WindowX_Int32 );
    m_nWindowY = vr::VRSettings()->GetInt32( k_pch_VirtualCheap_Section, k_pch_VirtualCheap_WindowY_Int32 );
    m_nWindowWidth = vr::VRSettings()->GetInt32( k_pch_VirtualCheap_Section, k_pch_VirtualCheap_WindowWidth_Int32 );
    m_nWindowHeight = vr::VRSettings()->GetInt32( k_pch_VirtualCheap_Section, k_pch_VirtualCheap_WindowHeight_Int32 );
    m_nRenderWidth = vr::VRSettings()->GetInt32( k_pch_VirtualCheap_Section, k_pch_VirtualCheap_RenderWidth_Int32 );
    m_nRenderHeight = vr::VRSettings()->GetInt32( k_pch_VirtualCheap_Section, k_pch_VirtualCheap_RenderHeight_Int32 );
    m_flSecondsFromVsyncToPhotons = vr::VRSettings()->GetFloat( k_pch_VirtualCheap_Section, k_pch_VirtualCheap_SecondsFromVsyncToPhotons_Float );
    m_flDisplayFrequency = vr::VRSettings()->GetFloat( k_pch_VirtualCheap_Section, k_pch_VirtualCheap_DisplayFrequency_Float );
...
std::string DeviceDriver_VirtualCheap::GetSerialNumber() const
{
